...
export * from '@domains/gestao-caixa/models/register-opening.types';
export * from '@domains/gestao-caixa/models/register-closing.types';
...
export * from '@domains/pdv/models/pdv.models';
...
export * from '@domains/pdv/api/pdv-catalog.service';
export * from '@domains/pdv/api/pdv-sale-submission.service';
