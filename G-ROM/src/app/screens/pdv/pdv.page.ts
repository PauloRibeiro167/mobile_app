...
import { CartItem, PdvStore } from './pdv.store';
import { AuthService, PdvSaleSubmissionService } from '../../core/services';
import { CartItemView, ConfirmedSale, PaymentMethod } from '../../core/models/pdv.models';
...
@Component({
  ...
  providers: [DecimalPipe, AlertController, ModalController]
})
